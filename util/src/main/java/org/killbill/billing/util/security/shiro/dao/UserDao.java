...
public interface UserDao {
    ...
    public void insertUser(String name, String surname, String mobileNumber, String username, String password, List<String> roles, String createdBy) throws SecurityApiException;
